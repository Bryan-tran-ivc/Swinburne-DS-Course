...
# Handles floating text elements that move upward and expire
class Text(object):
    def __init__(self, text, fontsize, rectcenter, font='Emulogic', textcolor = (255, 255, 255)):
        # Initialize font and render the text surface at a specific center point
    ...
    def update(self, core):
        # Move text upward and remove it once it has drifted 100 pixels
        self.rect.y -= 1
        self.y_offset -= 1
    ...
    def render(self, core):
        # Draw text at a static screen position (UI)
        core.screen.blit(self.text, self.rect)

    def render_in_game(self, core):
        # Draw text relative to the camera (world-space)
